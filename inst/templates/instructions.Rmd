...
This function requires only one input argument:

1. **path** A path to the dataset working directory containing `attributes_datatablename.txt` files and the respecive data tables.
...
A tab delimited `catvars_datatablename.txt` will be created for each of your data tables containing categorical variables. Open these in a spreadsheet editor and add definitions for each code. Do not edit this file in a text editor.
