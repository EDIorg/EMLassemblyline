...
Move the final versions of your data entities (tables or zip files) into this directory. These should be the final versions of the data you are ready to publish.
...
Right now the assembly line only works for data in tabular format. If your data is something other than tabular, we appologize for the wait. Check back soon!
...
Run the function `import_templates` to populate the working directory with the core metadata templates for you to complete. You will need to supply a few arguments for this function to work correctly.
