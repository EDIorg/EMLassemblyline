...
*  __`template_spatial_attributes()`__ Describes a raster or vector spatial data objects. 
*  __`template_raster_variables()`__ Describes categorical variables of spatial raster data (if any raster data are classified as categorical in spatial attributes template)
