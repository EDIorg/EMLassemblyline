...
*  __`template_physical()`__ Describe physical format of data objects (file description, size, MD5 hash, object type) providing explicit control over some metadata inferred by `make_eml()`. Also supports creation of EML describing data objects inaccessible to `make_eml()`, possibly because of file size.
