...
setwd('/Users/csmith/Desktop/data_packages/edi_301')
...
# Create templates for data table attributes
...
# View contents of attribute templates
# NOTE: attributeName and class is automatically populated, and unit and dateTimeFormatString note where content should be added.

```

```{r view attributes, echo=FALSE}

# Set taxa column to character
...
# View contents of categorical variable templates
# NOTE: attributeName and code is automatically populated.
...
# View contents of geographic coverage template
...
# View contents of taxonomic coverage template
# NOTE: Unresolved taxa have missing authority information
