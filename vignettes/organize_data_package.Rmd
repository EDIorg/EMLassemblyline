...
An even simpler organization scheme, albeit more cluttered, is a single data package directory containing all files belonging to that data package. Alternatively, use the `path`, `data.path`, and `eml.path` arguments of EAL functions to customize file organization.