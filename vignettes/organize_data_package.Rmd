...
*  __objects__ A directory of objects to package (e.g. data tables, analysis scripts, .zip files, etc.).
...
unlink(
  x = 'C:/Users/Colin/Desktop/data_packages/edi_301',
  recursive = TRUE
)
```

```{r template_directories, echo=TRUE, paged.print=TRUE}

# Create the standard data package directory structure

template_directories(
  path = 'C:/Users/Colin/Desktop/data_packages',
  dir.name = 'edi_301'
)
...
dir(
  'C:/Users/Colin/Desktop/data_packages/edi_301'
)

```

You may use any organization scheme you'd like, as long as the metadata template files belonging to a data package are all stored in the same directory.