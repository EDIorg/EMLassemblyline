...
* **role** Person’s role with respect to the data package. Persons serving more than one role, or roles shared among more than one person, should be added as separate lines. Valid roles are:
    ...
    + **publisher** Data package publisher. Can be a person, organization, or position (e.g. data manager). Note: Data repositories are publishers and may replace the contents you supply with their own.
