...
## shape_attributes.txt

Describes an ESRI shapefile.

Columns:

* **extname** The filename (without extension) of an ESRI shapefile (e.g. Culebra_plots would be the extname of a shapefile consisting of Culebra_plots.shp, Culebra_plots.dbf, etc.)
* **root_dir** Name of directory that holds shapefile components.
* **description** Description of the spatial file.
* **geoDescription** Description of the geographic coverage of the spatial file.
* **url** Accessible url for download of the file.
* **overwrite** If set to TRUE, this will allow the build_shape_element function to overwrite existing directory (the directory specified in root_dir)

[__Example__](https://docs.google.com/spreadsheets/d/1c8vnu_wlEJOnugGSIm2zzd26Gv749UBjYFVMY5Dc5qI/edit?usp=sharing)

## vector_attributes.txt

Describes spatial vector data (GeoJSON or KML).

Columns:

* **filename** Filename of some vector data.
* **layer** The layer to be processed (if multiple layers in the file).
* **driver** Name of vector data format. ('kml', 'geojson')
* **description** Description of the spatial file.
* **geoDescription** Description of the geographic coverage of the spatial file.
* **url** Accessible url for download of the file.
* **overwrite** If set to TRUE, this will allow the build_shape_element function to overwrite existing directory (the directory specified in root_dir)

[__Example__](https://docs.google.com/spreadsheets/d/1yStyFZAeiD91ebGM4wiS-66JWF4LS88hFWptX87XmoQ/edit?usp=sharing)

## raster_attributes.txt

Describes spatial raster data.

Columns:

* **filename** Filename of some raster data.
* **description** Description of the spatial file.
* **geoDescription** Description of the geographic coverage of the spatial file.
* **url** Accessible url for download of the file.
* **definition** Definition of an attribute.
* **unit** Unit of an attribute.
* **numberType** The type of data for the attribute ('real', 'natural', 'integer', 'whole', 'categorical'). For categorical variables, choose categorical.

[__Example__](https://docs.google.com/spreadsheets/d/1DaMqcnVAXOZ1rxD2ECDQWNnmXCgjUGhWvrJCPFhuO9s/edit?usp=sharing)

## raster_catvars.txt

Describes the categorical variables associated with spatial raster data.

Columns:

* **filename** Filename of a spatial raster file.
* **code** Categorical variable.
* **definition** Definition of a categorical variable.
